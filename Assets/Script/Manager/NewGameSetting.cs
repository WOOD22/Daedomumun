...
public class NewGameSetting : MonoBehaviour
{
    ...
    {
        game_data.schools[0].coach.name = coach_name_text.text;
    }
    //코치 성별 결정 함수(남)======================================================================
    public void Coach_Gender_Male_Decision()
    {
        game_data.schools[0].coach.gender = 'M';
    }
    //코치 성별 결정 함수(여)======================================================================
    public void Coach_Gender_Female_Decision()
    {
        game_data.schools[0].coach.gender = 'F';
    }
    //코치 생월 결정 함수==========================================================================
    public void Coach_Birth_Month_Decision(int birth)
    {
        game_data.schools[0].coach.birth_month = birth;
    }
    //학교 이름 확정 함수==========================================================================
    public void School_Name_Agree()
    {
        game_data.schools[0].name = school_name_text.text;
    }
    //=============================================================================================
